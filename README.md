# :people_holding_hands: Customers Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Customers-Power-Toy-For-Magento-2-small.png">  

Customers Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a dashboard toy 
providing statistics about customer accounts in your store.
...
<td>
    <table>
     <tr>
        <td><b>Customers Toy</b><br>Dark Mode</td>
        <td><b>Customers Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Customers-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Customers-Power-Toy-Light.jpg"></td>
    </tr>
    </table>
</td>
...
```
composer require jajuma/pot-customers
```

## Using Customers Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Customers Toy.  
...
displaying the Customers Toy.  

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Customers_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-customers/blob/master/LICENSE)
